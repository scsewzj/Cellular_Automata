...
def SimulateCA(cellautomaton0: np.ndarray, f, neighborhood=Moore(1), duration: int = 100, global_fn = None, extend = False) -> list:
    ...
    def global_ca_step(ca_step):
        """Decorator to apply a global function to the cellular automaton at each step of the simulation.

        Args:
            global_fn (function): function to be applied at each step of the simulation.
...
_neighbors_radio = None  # neighborhood radio butto
